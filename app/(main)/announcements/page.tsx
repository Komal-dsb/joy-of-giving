...
const AnnouncementsDisplay = () => {
  ...
  const upcomingAnnouncements = announcements.filter((ann) =>
    isUpcomingEvent(ann.event_date)
  );
  const pastAnnouncements = announcements.filter(
    (ann) => !isUpcomingEvent(ann.event_date)
  );
                    ...
                    <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <span className="text-red-600 font-semibold uppercase text-sm">
                          {isUpcomingEvent(featuredAnnouncement.event_date)
                            ? "Upcoming Event"
                            : "Past Event"}
                        </span>
                      </div>
                      ...
                      <CardContent className="p-6">
                        ...
                        {announcement.brochure_url && (
                          <a
                            ...
                            className="inline-flex items-center text-red-600 hover:text-red-700 font-semibold text-sm transition-colors duration-300"
                          >
