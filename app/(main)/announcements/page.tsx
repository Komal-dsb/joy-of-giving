...
const AnnouncementsDisplay = () => {
  ...
  const upcomingAnnouncements = announcements.filter((ann) => isUpcomingEvent(ann.event_date))
  const pastAnnouncements = announcements.filter((ann) => !isUpcomingEvent(ann.event_date))
                    ...
                    <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <span className="text-red-600 font-semibold uppercase text-sm">
                          {isUpcomingEvent(featuredAnnouncement.event_date) ? "Upcoming Event" : "Past Event"}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="flex items-center text-sm text-gray-500">
                          ...
                          {formatDate(featuredAnnouncement.event_date)}
                        </div>
                        <div className="flex items-center text-sm text-gray-500">
                          <MapPin className="w-4 h-4 mr-1" />
                          {featuredAnnouncement.event_venue}
                        </div>
                      </div>
