...
export default function ProgramsPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 pt-20 pb-28">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-5 tracking-tight">
            Our <span className="text-background">Programs</span>
          </h1>
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-r from-background to-background text-white text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button className="bg-white  text-background hover:bg-white px-8 py-4 text-lg rounded-full font-semibold">
            Donate Now
          </Button>
          <Button
            variant="outline"
           className="bg-white  text-background hover:text-background hover:bg-white px-8 py-4 text-lg rounded-full font-semibold"
          >
            Volunteer With Us
          </Button>
        </div>
