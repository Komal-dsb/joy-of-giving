...
export default function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-6 rounded-xl mx-auto">
      <motion.div
          ...
          <motion.div {...iconMotion}>
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="rounded-full bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 text-white p-2"
              >
